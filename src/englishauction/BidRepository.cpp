...
HX_LOCAL_STACK_FRAME(_hx_pos_15d4c0743c64d545_21_Add,"englishauction.BidRepository","Add",0x5584027f,"englishauction.BidRepository.Add","englishauction/BidRepository.hx",21,0xf18aee53)
HX_LOCAL_STACK_FRAME(_hx_pos_15d4c0743c64d545_26_Add,"englishauction.BidRepository","Add",0x5584027f,"englishauction.BidRepository.Add","englishauction/BidRepository.hx",26,0xf18aee53)
...
HX_LOCAL_STACK_FRAME(_hx_pos_15d4c0743c64d545_30_Edit,"englishauction.BidRepository","Edit",0x80a30bec,"englishauction.BidRepository.Edit","englishauction/BidRepository.hx",30,0xf18aee53)
HX_LOCAL_STACK_FRAME(_hx_pos_15d4c0743c64d545_34_Remove,"englishauction.BidRepository","Remove",0x011a9aa6,"englishauction.BidRepository.Remove","englishauction/BidRepository.hx",34,0xf18aee53)
HX_LOCAL_STACK_FRAME(_hx_pos_15d4c0743c64d545_40_FindById,"englishauction.BidRepository","FindById",0x578ee14d,"englishauction.BidRepository.FindById","englishauction/BidRepository.hx",40,0xf18aee53)
HX_LOCAL_STACK_FRAME(_hx_pos_15d4c0743c64d545_48_GetNumberOfBids,"englishauction.BidRepository","GetNumberOfBids",0x6428848a,"englishauction.BidRepository.GetNumberOfBids","englishauction/BidRepository.hx",48,0xf18aee53)
HX_LOCAL_STACK_FRAME(_hx_pos_15d4c0743c64d545_53_GetNumberOfBids,"englishauction.BidRepository","GetNumberOfBids",0x6428848a,"englishauction.BidRepository.GetNumberOfBids","englishauction/BidRepository.hx",53,0xf18aee53)
HX_LOCAL_STACK_FRAME(_hx_pos_15d4c0743c64d545_43_GetNumberOfBids,"englishauction.BidRepository","GetNumberOfBids",0x6428848a,"englishauction.BidRepository.GetNumberOfBids","englishauction/BidRepository.hx",43,0xf18aee53)
HX_LOCAL_STACK_FRAME(_hx_pos_15d4c0743c64d545_63_GetHighestBids,"englishauction.BidRepository","GetHighestBids",0xf1bc98c6,"englishauction.BidRepository.GetHighestBids","englishauction/BidRepository.hx",63,0xf18aee53)
...
HX_LOCAL_STACK_FRAME(_hx_pos_15d4c0743c64d545_57_GetHighestBids,"englishauction.BidRepository","GetHighestBids",0xf1bc98c6,"englishauction.BidRepository.GetHighestBids","englishauction/BidRepository.hx",57,0xf18aee53)
...
void BidRepository_obj::Add( ::englishauction::BidModel bid, ::Dynamic callback){
            		HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::Dynamic,callback) HXARGC(1)
            		 ::maglev::MagLevResult _hx_run( ::maglev::MagLevAny ret){
            			HX_STACKFRAME(&_hx_pos_15d4c0743c64d545_21_Add)
HXLINE(  22)			 ::Dynamic callback1 = callback;
HXDLIN(  22)			callback1(::hx::TCast<  ::maglev::MagLevString >::cast(ret)->getString());
HXLINE(  23)			return ::maglev::MagLevResult_obj::fromResult(::maglev::MagLevNull_obj::create());
            		}
            		HX_END_LOCAL_FUNC1(return)

            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_1) HXARGC(1)
            		 ::maglev::MagLevResult _hx_run( ::maglev::MagLevError err){
            			HX_STACKFRAME(&_hx_pos_15d4c0743c64d545_26_Add)
HXLINE(  26)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(err->getMessage()));
...
HXLINE(  19)		args->push(data);
HXLINE(  20)		 ::maglev::MagLevResult res = this->bus->call(HX_("Persistence.EnglishAuction.Bid.New",e3,a0,41,4a),args);
HXLINE(  21)		res->onResult( ::Dynamic(new _hx_Closure_0(callback)));
HXLINE(  25)		res->onError( ::Dynamic(new _hx_Closure_1()));
            	}
...
void BidRepository_obj::Edit( ::englishauction::BidModel bid){
            	HX_STACKFRAME(&_hx_pos_15d4c0743c64d545_30_Edit)
            	}
...
void BidRepository_obj::Remove(::String bidId){
            	HX_STACKFRAME(&_hx_pos_15d4c0743c64d545_34_Remove)
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(BidRepository_obj,Remove,(void))
 ...
 ::englishauction::BidModel BidRepository_obj::FindById(::String bidId){
            	HX_STACKFRAME(&_hx_pos_15d4c0743c64d545_40_FindById)
...
void BidRepository_obj::GetNumberOfBids(::String auctionId, ::Dynamic callback){
            		HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::Dynamic,callback) HXARGC(1)
            		 ::maglev::MagLevResult _hx_run( ::maglev::MagLevAny result){
            			HX_STACKFRAME(&_hx_pos_15d4c0743c64d545_48_GetNumberOfBids)
HXLINE(  49)			 ::Dynamic callback1 = callback;
HXDLIN(  49)			callback1(::hx::TCast<  ::maglev::MagLevNumber >::cast(result)->getInt());
HXLINE(  50)			return ::maglev::MagLevResult_obj::fromResult(::maglev::MagLevNull_obj::create());
            		}
            		HX_END_LOCAL_FUNC1(return)

            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_1) HXARGC(1)
            		 ::maglev::MagLevResult _hx_run( ::maglev::MagLevError error){
            			HX_STACKFRAME(&_hx_pos_15d4c0743c64d545_53_GetNumberOfBids)
HXLINE(  53)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(error->getMessage()));
HXDLIN(  53)			return null();
            		}
            		HX_END_LOCAL_FUNC1(return)

            	HX_STACKFRAME(&_hx_pos_15d4c0743c64d545_43_GetNumberOfBids)
HXLINE(  44)		 ::maglev::MagLevArray args = ::maglev::MagLevArray_obj::create();
HXLINE(  45)		args->push(::maglev::MagLevString_obj::fromString(auctionId));
HXLINE(  46)		 ::maglev::MagLevResult ret = this->bus->call(HX_("Persistence.EnglishAuction.Bid.CountForAuction",ec,c0,3b,c5),args);
HXLINE(  47)		int count = 0;
HXLINE(  48)		ret->onResult( ::Dynamic(new _hx_Closure_0(callback)));
HXLINE(  52)		ret->onError( ::Dynamic(new _hx_Closure_1()));
            	}
...
void BidRepository_obj::GetHighestBids(::String auctionId,int numBids, ::Dynamic callback){
            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(1)
            		 ::maglev::MagLevResult _hx_run( ::maglev::MagLevError error){
            			HX_STACKFRAME(&_hx_pos_15d4c0743c64d545_63_GetHighestBids)
HXLINE(  63)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(error->getMessage()));
HXDLIN(  63)			return null();
            		...
            		HX_BEGIN_LOCAL_FUNC_S2(::hx::LocalFunc,_hx_Closure_1,::String,auctionId, ::Dynamic,callback) HXARGC(1)
            		 ::maglev::MagLevResult _hx_run( ::maglev::MagLevAny onres){
            			HX_GC_STACKFRAME(&_hx_pos_15d4c0743c64d545_65_GetHighestBids)
HXLINE(  66)			 ::maglev::MagLevArray arr = ::hx::TCast<  ::maglev::MagLevArray >::cast(onres);
HXLINE(  67)			::Array< ::Dynamic> bids = ::Array_obj< ::Dynamic>::__new();
HXLINE(  68)			int i = 0;
HXLINE(  69)			while((i < arr->size())){
HXLINE(  70)				 ::englishauction::BidModel model =  ::englishauction::BidModel_obj::__alloc( HX_CTX );
HXLINE(  71)				 ::maglev::MagLevObject resobj = ::hx::TCast<  ::maglev::MagLevObject >::cast(arr->get(i));
HXLINE(  72)				model->id = ::hx::TCast<  ::maglev::MagLevString >::cast(resobj->get(HX_("bidId",f8,61,f8,b2)))->getString();
HXLINE(  73)				if (resobj->exists(HX_("auctionId",fe,08,7f,46))) {
HXLINE(  74)					model->auctionId = ::hx::TCast<  ::maglev::MagLevString >::cast(resobj->get(HX_("auctionId",fe,08,7f,46)))->getString();
            				}
            				else {
HXLINE(  76)					model->auctionId = auctionId;
            				}
HXLINE(  78)				model->userId = ::hx::TCast<  ::maglev::MagLevString >::cast(resobj->get(HX_("userId",06,3b,ef,41)))->getString();
HXLINE(  79)				model->price = ::hx::TCast<  ::maglev::MagLevNumber >::cast(resobj->get(HX_("price",89,4e,8b,c8)))->getFloat();
HXLINE(  80)				bids->push(model);
HXLINE(  81)				i = (i + 1);
            			}
HXLINE(  83)			callback(bids);
HXLINE(  84)			return ::maglev::MagLevResult_obj::fromResult(::maglev::MagLevNull_obj::create());
            		}
            		HX_END_LOCAL_FUNC1(return)

            	HX_STACKFRAME(&_hx_pos_15d4c0743c64d545_57_GetHighestBids)
HXLINE(  58)		 ::maglev::MagLevArray args = ::maglev::MagLevArray_obj::create();
HXLINE(  59)		args->push(::maglev::MagLevString_obj::fromString(auctionId));
HXLINE(  60)		args->push(::maglev::MagLevNumber_obj::fromInt(numBids));
HXLINE(  61)		 ::maglev::MagLevResult res = this->bus->call(HX_("Persistence.EnglishAuction.Bid.FindByHighestPriceForAuction",0c,88,9b,ea),args);
HXLINE(  62)		res->onError( ::Dynamic(new _hx_Closure_0()));
HXLINE(  65)		res->onResult( ::Dynamic(new _hx_Closure_1(auctionId,callback)));
            	}
